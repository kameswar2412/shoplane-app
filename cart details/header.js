$(document).ready(function(){
    ...
    var logoLink=$("<a>").attr("href","../index.html").html("SHOP")  //logolink
    ...
    var accessories=$("<a>").attr({"href":"../index.html#accessroy-section","id":"accessories","class":"m-link"
}).html("accessories")   //accessory link
